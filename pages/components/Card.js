  ...
  return (
    <Link href={"post/[post]"} as={`post/${id}`}>
      <div className="xl:w-1/3 md:w-1/2 p-4 cursor-pointer hover:-translate-y-2 transition-all ">
        <div className="border border-gray-200 p-6 rounded-lg min-h-[325px] hover:shadow-md hover:bg-gray-50 transition-all">
          ...
          <p className="my-5 text-slate-500 hover:underline">by User - {userId}</p>
        </div>
      </div>
    </Link>
  );
